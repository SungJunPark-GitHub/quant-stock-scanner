...
현재 `render.yaml`은 Render 무료 인스턴스의 512MB 메모리 제한을 고려해 자동 갱신을 꺼둔 상태입니다.

```text
START_BACKGROUND_UPDATES=0
AUTO_UPDATE_ENABLED=0
```

무료 배포판에서는 저장된 스냅샷을 빠르게 서빙하고, 데이터는 로컬에서 업데이트한 뒤 GitHub에 푸쉬하는 방식을 권장합니다.
